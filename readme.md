...
1. Replace `<your_account>` with your Github username in the links
    - [DEMO LINK](https://Slavacheban.github.io/layout_search-bar-airbnb/)
    - [TEST REPORT LINK](https://Slavacheban.github.io/layout_search-bar-airbnb/report/html_report/)
